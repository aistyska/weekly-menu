        ...
        <div class="col mb-4 card-grow">
            <div class="card text-center">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('generate') }}" class="btn btn-outline-dark mt-auto stretched-link">Generuoti</a>
                </div>
            </div>
        </div>
        <div class="col mb-4 card-grow">
            <div class="card text-center">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('manual') }}" class="btn btn-outline-dark mt-auto stretched-link">Išsirinkti patiekalus</a>
                </div>
            </div>
        </div>
        <div class="col mb-4 card-grow">
            <div class="card text-center">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('genAndManual') }}" class="btn btn-outline-dark mt-auto stretched-link">Generuoti ir rinktis</a>
                </div>
            </div>
        </div>
        <div class="col mb-4 card-grow">
            <div class="card text-center">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('previousMenu') }}" class="btn btn-outline-dark mt-auto stretched-link">Rinktis iš buvusių</a>
                </div>
            </div>
        </div>
    </div>
